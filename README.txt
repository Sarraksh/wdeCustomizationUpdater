...
В поле RedundantFiles могут быть указаны паттерны для исключения файлов из обработки
...
В случае, если необходимо исключить дополнительные типы файлов, можно указать их в опции RedundantFiles.
